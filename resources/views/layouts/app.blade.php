...
<html lang="pl">
    ...
    <body id="page-top">
        ...
        <footer class="footer text-center">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Footer Social Icons-->
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <h4 class="text-uppercase mb-4">Inne media</h4>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; Luki 2022</small></div>
        </div>
        <!-- Portfolio Modals-->
        <!-- Portfolio Modal 1-->
        ...
        <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
        <script src="{{ asset('js/sb-forms-latest.js') }}"></script>
    </body>
</html>
